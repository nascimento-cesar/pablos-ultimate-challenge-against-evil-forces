...
function CharacterSelectionScreen:draw(character_selection)
  ...
  Draw:print_outlined_text("⬅️", 40, 64, btn(⬅️) and 7 or 12)
  Draw:draw_sprite(character_sprite, 58, 60, 2, 2)
  Draw:print_outlined_text("➡️", 80, 64, btn(➡️) and 7 or 12)
  Draw:print_outlined_text(character_info[1], Draw:get_h_center(character_info[1]), 86, 8)
  Draw:print_text_block(character_info[2], Draw:get_h_center(character_info[2]), 98)
end